...
SECRET_KEY = 'django-insecure-%hp*1s6tk1v#n^5#(z5mtz1zhor@c4wue1w8devfi4$#t=^(=-'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DATABASE_HOST', 'localhost'), # Use env var, default to localhost
        'PORT': '5432',
    }
}
...
AUTHENTICATION_BACKENDS = [
    'core.auth_backends.EmailOrUsernameModelBackend',  # Allow login with email or username
